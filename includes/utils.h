...
t_square	make_square(t_point center, t_point vec, double radius, \
			t_color color);
t_triangle	make_triangle(t_point point1, t_point point2, \
			t_point point3, t_color color);
t_cylinder	make_cylinder(t_point center, t_point vec, double *rad_hei, \
			t_color color);
